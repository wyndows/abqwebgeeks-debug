 ...
 * This is one of my students' capstone projects with a bug purposely injected
 * SPECIAL THANKS to the students I'm <del>stealing</del> borrowing from...
 * ...I love you Team Red Rovr!
 * @see https://redrovr.io/ the permanent home for their project
 **/
...
class User implements \JsonSerializable {
	 ...
	 **/
	public function _construct(int $newUserId = null, string $newUserEmail, int $newUserLoginId = null, string $newUserProviderKey, string $newUserName) {
		try {
...
$user = new User(null, "some@email.com", 1, "userKey", "nasa4ever");
var_dump($user);
