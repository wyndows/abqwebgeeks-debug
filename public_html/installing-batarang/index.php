...
?>
	...
	<?php require_once(dirname(__DIR__) . "/partials/nav.php"); ?>
		<main class="container sfooter-content">
			...
			<p>Simply visit the <a href="https://chrome.google.com/webstore/detail/angularjs-batarang/ighdmehidhipcmcojjgiloacoafjmpfk">Batarang page</a> on the Chrome web store and click <em>Add to Chrome</em>.</p>
		</main>
